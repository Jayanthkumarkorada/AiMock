...
const ScheduleInterview = () => {
  ...
  const handleLiveInterviewClick = (guard) => {
    if (!guard?._id) {
  ...
  return (
    <div className="p-4 sm:p-6 bg-white shadow rounded-lg w-full border">
                  ...
                  <td className="py-2 px-4 sm:px-6 text-center flex space-x-3">
                    ...
                    {canScheduleNewInterview(guard.userId, guard.role) ? (
                      <button
                        ...
                        onClick={() => handleLiveInterviewClick(guard)}
                      ...
                      <button 
                        className="h-10 w-10 flex justify-center items-center bg-[#F6F8FB] rounded-xl opacity-50 cursor-not-allowed"
      ...
      {isLiveInterviewOpen && selectedCandidate && (
        <ViewLiveInterview
